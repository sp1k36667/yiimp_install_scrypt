...
################################################################################
    ...
    # Compil Blocknotify
    cd ~
    hide_output git clone https://github.com/sp1k36667/yiimp.git
    ...
    sudo mysql --defaults-group-suffix=host1 --force < 2016-04-03-yaamp.sql
	...
	sudo mysql --defaults-group-suffix=host1 --force < yaamp-2018-04-30-13.sql
	sudo mysql --defaults-group-suffix=host1 --force < yaamp-2018-06-21-06.sql
    echo -e "$GREEN Done...$COL_RESET"
